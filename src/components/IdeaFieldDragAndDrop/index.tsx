...
import { DragAndDropContainer, ItemsContainer, ButtonSave, Value } from './styles';
...
export const IdeaFieldDragAndDrop = ({
    ...
    const { getCampaignIdeaFields, getDefaultIdeaFields, updateIdeaFieldsSequence, ideaFields } = useContext(ConfigContext);

    const [addNewField, setAddNewField] = useState(false);
    const [ideaFieldsState, setIdeaFieldsState] = useState<IdeaField[]>(ideaFields);
