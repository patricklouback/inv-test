...
export const ChangeCampaignModal: React.FC<ChangeCampaignModalProps> = ({
  ...
  const handleChangeCampaign = useCallback((e, campaignId) => {(async () => {
        // e.preventDefault();
  ...
  const handleCheckOrUncheckNewCampaign = useCallback(
    campaingId => {
    ...
    [idea.campaignId, newIdeaCampaign]
  );
    ...
    >
      ...
      >
        {idea.kanbanStep !== 'SELECT' ? (
          <Container onSubmit={(e) => handleChangeCampaign(e,newIdeaCampaign)}>
            <Title>
              Escolha o direcional para o qual deseja que a iniciativa seja
              alterada
            </Title>
            <CampaignsOptionsContainer>
                ...
                return (
                  ...
                  >
                    <InvisibleCheckbox
                      ...
                      key={campaign.id}
                      onChange={() =>
                        handleCheckOrUncheckNewCampaign(campaign.id)
                      }
                      checked={campaign.id === newIdeaCampaign}
                    />
                    <VisibleCheckbox
          ...
          <Container>
            ...
            <SubTitle>
              Iniciativas com Processo de Desenvolvimento ativo não podem ser
              movidas para outro Direcional
            </SubTitle>
            <SubTitle>
              Caso deseje mesmo movê-la, retorne-a para a etapa anterior.
            </SubTitle>
            <SubTitle>
              ATENÇÃO: Ao movê-la para outro Direcional, deverá ser escolhida
              uma nova Rota para a iniciativa e seu Processo de Desenvolvimento
              será resetado.
            </SubTitle>
          </Container>
        )}
