...
export const ItemStep: React.FC<ItemProps> = ({ colors }): JSX.Element => {
  ...
  const generatePath = (width): string => {
    ...
    const pathData = `
      ...
      C${xMultiplier(112.705)} 0 ${xMultiplier(118.552)} 3.921 ${xMultiplier(
      121.016
    )} 9.92552
      L${xMultiplier(132.507)} 37.9255
      C${xMultiplier(134.104)} 41.8177 ${xMultiplier(
      134.104
    )} 46.1823 ${xMultiplier(132.507)} 50.0745
      L${xMultiplier(121.016)} 78.0745
      C${xMultiplier(118.552)} 84.079 ${xMultiplier(112.705)} 88 ${xMultiplier(
      106.214
    )} 88
      H${xMultiplier(20)}
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_3032_3897)">
        <path d={generatePath(width)} fill={colors} />
      </g>
      <defs>
        <filter
