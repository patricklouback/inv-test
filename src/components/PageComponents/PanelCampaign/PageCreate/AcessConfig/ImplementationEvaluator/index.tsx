...
const EVALUATOR_IMPLEMENTATION_KEY = 'EVALUATOR_IMPLEMENTATION';

export const ImplementationEvaluator: React.FC = (): JSX.Element => {
  const {
    removeCampaignUser,
