...
export const IdeaFormConfig = ({
  ...
  const [isOpenImportTemplateModal, setIsOpenImportTemplateModal] = useState<boolean>(false);
    ...
    <Container>
      ...
      >
        <Form>
          ...
          />
          <Warning>
            <strong>Atenção: não cadastrar campos título, descrição e resumo.</strong>
          </Warning>
          <Row size={size}>
