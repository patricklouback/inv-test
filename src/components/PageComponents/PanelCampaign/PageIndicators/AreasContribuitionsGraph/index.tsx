...
export function AreasContribuitionsGraph({
  campaignIds,
  ...
  const areasThatContributed = areasContribution.filter(
    area => area.totalContribution > 0
  );
      ...
      <GraphFilterBar>
        <TitleFilterBar>
          ...
          <ExplanationTooltip>
            ...
            <ExplanationTooltipText>
              Iniciativas submetidas, likes e comentários de acordo com áreas
              cadastradas.
              <br />
              <br />
