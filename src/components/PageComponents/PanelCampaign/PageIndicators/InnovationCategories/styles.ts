...
export const InnovationContainer = styled.div`
  width: 100%;
`;
export const InnovationFilterBar = styled.div`
  width: 100%;
  display: flex;
  flex-direction: row;
  align-items: center;
...
export const InnovationTitleFilterBar = styled.div`
  width: auto;
  display: flex;
  align-items: center;
  gap: 1rem;
`;
export const InnovationIconContainer = styled.span`
  display: flex;
  align-items: center;
...
`;
export const InnovationButtonFilter = styled.button`
  width: auto;
  display: flex;
  align-items: center;
  border: none;
...
`;
export const InnovationSubtitleBar = styled.div`
  width: 100%;
  display: flex;
  flex-direction: row;
  align-items: center;
...
`;
export const InnovationSubtitle = styled.div<SubtitleProps>`
  display: flex;
  flex-direction: row;
  align-items: center;
