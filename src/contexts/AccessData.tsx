...
export const AccessDataContext = createContext<AccessDataPropsData>(
  {} as AccessDataPropsData
);

export const ProviderAccessData: React.FC = ({ children }): JSX.Element => {
  const accessTimeByMonth = useCallback(async (params?: any) => {
    try {
  ...
  return (
    <AccessDataContext.Provider value={AuthDataValue}>
      {children}
